...
<title>${bcCode.code_info },初学者论坛，beginCode,BeginCode</title>
<!-- Bootstrap -->
					...
					<div class="col-md-8" >
							  <div class="panel panel-primary" style="margin-top:0;" >
							  	<div class="panel-body">
							       <h3 ><img src="${ctx}/images/yuan.gif"/>&nbsp;<img src="${ctx}/images/jian.gif"/>&nbsp;${bcCode.code_info } 代码标题</h3>
							       <hr style="border:none;border-top:2px solid blue; height:0;" />
					<c:if test="${bcCode.code_url ne '' }">
					 <p style="font-size:12px;color:blue;">下载地址：${bcCode.code_url }</p>
					</c:if>
    <p>${bcCode.code_content }
</p>
							       <p style="text-align: right;"><b>作者</b>(${bcCode.writer }) &nbsp; | &nbsp;<b>阅读</b>(${bcCode.view_count })&nbsp; </p>
<form >
    ...
    <li class="next"><a href="#">下一页 <span aria-hidden="true">&rarr;</span></a></li>
					...
					<div class="col-md-4">
						<div class="list-group">
							<a href="#" class="list-group-item active"> 相关课程 </a> 
