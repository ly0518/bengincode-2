		...
		<div class="row" >
					<div class="col-md-9" >
							  <div class="panel panel-primary" style="margin-top:0;" >
							     ...
							     <span class="icon " style="background:#fd6245;">顶</span> <span class="icon" style="background:#44ac57; "  title="原创博客">原</span> ${blog.blogInfo }
							      </h3>
							       <hr style="border:none;border-top:2px solid blue; height:0;" />
    <p>${blog.blogContent }
     
</p>
<span class="r blogAuthLabel"><b>作者</b>(${blog.nickname }) &nbsp; | &nbsp;<b>阅读</b>(${blog.viewCount })&nbsp;  
								</span>
								<p>
<form name="blogCommonForm" id="blogCommonForm" style="margin-top:20px;">
<div class="form-group">
   <input type="hidden" name="blogId" id="blogId" value="${blog.blogId }" />
   <textarea class="form-control required"  id="blogCommentContent" name="blogCommentContent"  rows="3" placeholder="一句话评论"></textarea>
   </div>
   <div class="form-group">
           <button type="button" id="pubBlogCommon" class="btn pub-btn btn-primary  r">发表评论</button>
      </div>
...
<!-- 评论结束 -->
					...
					<div class="col-md-3">
					   <div class="list-group">
							...
							<div id="relationBlogTopFive"></div>
						</div>
						<div class="list-group">
