...
<title>${proStage.stage_name },初学者论坛,beginer,BeginCode,beginCode</title>
<!-- Bootstrap -->
...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			<h1>${project.project_name }名称</h1>
			<p>${project.project_intro }介绍</p>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-8">
				<div class="panel panel-primary" style="margin-top: 0;">
					<div class="panel-body">
						<h3>
							<img src="${ctx}/images/yuan.gif" />&nbsp;<img
								src="${ctx}/images/jian.gif" />&nbsp;${proStage.stage_name }
						</h3>
						<hr style="border: none; border-top: 2px solid blue; height: 0;" />
						<p>${proStage.stage_content }</p>
						<p style="text-align: right;">
							<b>作者:</b>冷水源 &nbsp; | &nbsp;<b>阅读</b>(${proStage.view_count })&nbsp;
						</p>
							...
							<ul class="commentcon">
								<li>
									<div class="notelist_headpic">
										<a href="/space/u/uid/1967307" target="_blank"><img
											src='http://img.mukewang.com/user/5557f91e0001115601000100-40-40.jpg'
									...
									<div class="notelist_content">
										...
										<div class="notelist-bottom clearfix">
											<span title="创建时间" class="l timeago">时间：1天前</span> <a
												href="/video/5563" class="from-course">源自：1-2
												事务与分布式事务原理与实践(二)</a>
											<div class="notelist-actions">
												<a title="赞" href="javascript:;"
													class="js-pl-praise list-praise " data-id="51545"> <span
													class="icon icon_good "></span> <em>0</em></a>
											</div>
										</div>
								</li>
								<li>
			...
			<div class="col-md-4">
				...
				<div class="list-group">
					<a href="#" class="list-group-item active"> 相关内容 </a>
					<c:forEach items="${relProStage}" var="projectStage">
						<a
							href="${ctx}/project/viewProStage/${projectStage.project_stage_id}.html"
							class="list-group-item">${projectStage.stage_name}</a>
					</c:forEach>
				</div>
			</div>
		</div>
