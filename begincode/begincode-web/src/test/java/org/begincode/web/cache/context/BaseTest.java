 ...
 * @version V1.0   
 */
package org.begincode.web.cache.context;
...
@ContextConfiguration(locations = { "classpath:applicationContext-task.xml",
		"classpath:applicationContext-core.xml","classpath:applicationContext-course.xml","classpath:applicationContext-code.xml" })
